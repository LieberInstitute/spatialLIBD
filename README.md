...
#> 1.1.1, <URL: http://www.bioconductor.org/packages/spatialLIBD>.
#> 
...
#>     note = {https://github.com/LieberInstitute/spatialLIBD - R package version 1.1.1},
...
-   The [documentation website](http://lieberinstitute.github.io/spatialLIBD) is automatically updated thanks to *[pkgdown](https://CRAN.R-project.org/package=pkgdown)*.
