...
```{r 'subset_to_reduce_mem_on_travis', echo = FALSE, eval = FALSE}
...
system(paste('ls -lh', here::here('data-raw', 'sce_sub_for_vignette.Rdata')))
# 36M Feb 23 09:39 spatialLIBD/data-raw/sce_sub_for_vignette.Rdata
```

```{r 'download_fake', eval = FALSE}
## Query ExperimentHub and download the data
sce <- fetch_data(type = 'sce', eh = ehub)
```


```{r 'download_hidden', echo = FALSE}
vignette_data <- function(destdir = tempdir()) {
    sce_sub <- NULL
