...
One of the goals of `spatialLIBD` is to provide options for visualizing Visium data. In
...
plotting the spatial distribution of a single gene or continuous variable of interest. We'll
first define several genes known to be markers for white matter `r Citep(bib[['tran2021']])`.
...
Next, we'll plot just the expression of *GFAP*.
