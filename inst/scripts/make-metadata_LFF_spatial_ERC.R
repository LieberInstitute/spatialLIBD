...
meta <- data.frame(
    Title = c(
        ...
        "LFF_spatial_ERC_snRNAseq_pseudobulk",
        "LFF_spatial_ERC_snRNAseq_modeling_results"
    ),
    Description = c(
        ...
        "Pseudo-bulked SingleCellExperiment object LFF_spatial_ERC human brain (ERC) snRNA-seq data (n = 31) from the Chromium platform from 10x Genomics generated by the Lieber Institute for Brain Development (LIBD) and available through the spatialLIBD Bioconductor package.",
        "List of modeling results at the 38 subcluster resolution for the LFF_spatial_ERC human brain (ERC) spatial transcriptomics data (n = 31) from the Chromium platform from 10x Genomics generated by the Lieber Institute for Brain Development (LIBD) and available through the spatialLIBD Bioconductor package."
    ),
    BiocVersion = "3.17",
    Genome = "GRCh38",
    SourceType = "GTF",
    ...
    DispatchClass = c("FilePath", "Rds", "Rds", "FilePath", "Rds", "Rds"),
    RDataPath = file.path(
        pkgname,
        outdir,
        c(
