...
[![Travis build status](https://travis-ci.com/LieberInstitute/spatialLIBD.svg?branch=master)](https://travis-ci.com/LieberInstitute/spatialLIBD)
...
* Inspecting the data interactively either on your computer or through [spatial.libd.org/spatialLIBD/](https://spatial.libd.org/spatialLIBD/).
